...
from .utils_PDF import extract_PDFs
...
def download_and_extract(
    ...
    download_proc = Process(
        ...
        args=(years, filters, n_jobs[0], timeout_loadpage, timeout_startdw, save_pdfs_to))

    extract_proc = Process(
        target=extract_PDFs,
        args=(years, filters, n_jobs[1], timeout_per_article, save_pdfs_to, keep_pdfs))
